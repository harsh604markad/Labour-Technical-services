Public Class Travellbill
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString(GunaLabel2.Text, font1, Brushes.Black, 100, 300)
        e.Graphics.DrawString(GunaTextBox2.Text, font1, Brushes.Black, 300, 300)
        e.Graphics.DrawString(GunaLabel3.Text, font1, Brushes.Black, 100, 400)
